...
export default function SettingsPage() {
  ...
  const requestLive = () => {
    if (!status?.configured) {
      useUiStore
        .getState()
        .showToast("먼저 .env.local 에 Upbit API 키를 설정하세요.", "danger");
      return;
    }
    setConfirmOpen(true);
  };
        ...
        <Stack>
            ...
            <GlassCard padding={4}>
              <Row>
                <RowText>
                  ...
                  <RowDesc>
                    OFF면 실거래 봇은 <b>매도(손절/익절) 신호만</b> 실행합니다. 신규 진입(매수)은 하지
                    않아 자본을 보호합니다.
                  </RowDesc>
                </RowText>
          ...
          <div>
            ...
            <WarnBox>
              ...
              <WarnText>
                실행 중인 봇 {runningBots}개를 즉시 정지하고 모의거래(TEST) 모드로 되돌립니다. 시장이
                급변할 때 사용하세요.
              </WarnText>
